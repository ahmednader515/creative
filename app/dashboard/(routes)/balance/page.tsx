        ...
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              إضافة رصيد عبر فودافون كاش أو اتصالات كاش
            </CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">رقم اتصالات كاش</p>
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>قم بتحويل المبلغ المطلوب إلى أحد الأرقام أعلاه (فودافون كاش أو اتصالات كاش)</li>
